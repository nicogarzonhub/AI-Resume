...
export type LogoItem = LogoNode | LogoImage;
  ...
  useEffect(() => {
    ...
    return () => {
      images.forEach(img => {
        ...
        (img as HTMLImageElement).removeEventListener('error', handleImageLoad);
      });
    };
    // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const itemAriaLabel = isNodeItem ? (item.ariaLabel ?? item.title) : ((item as LogoImage).alt ?? item.title);
